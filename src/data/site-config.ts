...
// Fallback sin tipos: evita el error TS en import.meta.env
const base: string = (import.meta as any).env?.BASE_URL ?? '/';

const siteConfig: SiteConfig = {
  website: 'https://example.com',
  avatar: { src: `${base}images/Avatar.jpeg`, alt: 'Samuel Junca' },
  title: 'Samuel',
  subtitle: 'Systems Engineering',
  description: 'Astro.js and Tailwind CSS theme for blog and portfolio by justgoodui.com',
  image: { src: `${base}images/Avatar.jpeg`, alt: 'Dante - Astro.js and Tailwind CSS theme' },
  headerNavLinks: [
    { text: 'Home', href: '/' },
...
Well‑crafted software, thoughtful visual design, and products that solve real problems.`,
    image: {
      src: `${base}images/hero.jpg`, // o `${base}images/Avatar.jpeg` si no tienes hero.jpg
      alt: 'A person sitting at a desk in front of a computer',
    },
    actions: [{ text: 'Get in Touch', href: '/contact' }],
  },
  subscribe: { enabled: true, title: 'Subscribe to Dante Newsletter', text: 'One update per week. All the latest posts directly in your inbox.', form: { action: '#' } },
  postsPerPage: 8,
  projectsPerPage: 8,
};
